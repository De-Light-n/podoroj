...
const Dropdown = ({ title, children, to, isOpen, setIsOpen }) => {
    ...
    return (
        <li
            ...
            ref={dropdownRef}
        >
            <Link to={to} className="dropdown-trigger">{title} +</Link>
    ...
    const articlesData = [
        ...
        },
        {
            ...
            links: [
                ...
                { to: "/articles/culture", text: "Переглянути всі", className: "view-all" }
            ]
        },
        {
            title: "Путівники",
            links: [
                ...
                { to: "/articles/guides", text: "Переглянути всі", className: "view-all" }
            ]
        },
        {
            ...
            links: [
                ...
                { to: "/articles/life-on-road", text: "Переглянути всі", className: "view-all" }
            ]
        }
    ];
    ...
    const directionsData = [
        ...
        },
        {
            ...
            links: [
                ...
                { to: "/destinations/asia", text: "Дивитися всі", className: "view-all" }
            ]
        },
        {
            title: "Америка",
            links: [
                ...
                { to: "/destinations/america", text: "Дивитися всі", className: "view-all" }
            ]
        },
        {
            title: "Африка",
            links: [
                ...
                { to: "/destinations/africa", text: "Дивитися всі", className: "view-all" }
            ]
        },
        {
            title: "Океанія",
            links: [
                ...
                { to: "/destinations/oceania", text: "Дивитися всі", className: "view-all" }
            ]
        },
        {
            ...
            links: [
                ...
                { to: "/destinations/polar", text: "Дивитися всі", className: "view-all" }
            ]
        }
    ];
