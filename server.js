...
app.post("/api/favorites", async (req, res) => {
  try {
    ...
    if (!userId || !articleId) {
      console.error("Missing required fields - userId:", userId, "articleId:", articleId);
      return res.status(400).json({ error: "Missing required fields" });
    }

    console.log("Processing favorite for user:", userId, "and article:", articleId);
    ...
    console.log("Current state - isFavorite:", isFavorite, "articles:", articles);
